...
API_KEY = "4H29A6N1IXR30ZSJ"  # Replace with your actual API key
...
PG_HOST = 'localhost' # Replace with your actual host, probably 'localhost'
PG_DB = 'alphavantage_bi' # Replace with your actual database name
PG_USER = 'postgres' # Replace with your actual username, probably 'postgres'
PG_PASSWORD = '46824682' # Replace with your actual password
PG_PORT = '5432' # Replace with your actual port, default is 5432
